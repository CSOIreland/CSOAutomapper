...
namespace CSO.AutoMapper
{
    public static class AutoMap
    {
        static IDictionary<string, string> configurationDictionary;

        public static IMapper CreateMapper(IDictionary<string, string> configDict)
        {
            configurationDictionary = configDict;
        ...
        public class StringToDateTimeConverter : ITypeConverter<JValue, DateTime>
        {
            public DateTime Convert(JValue source, DateTime destination, ResolutionContext context)
            {
                ...
                {
                    string apiFormats = configurationDictionary["API_DATETIME_FORMAT"];
